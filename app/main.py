...
import uvicorn
from app.routers import example_router, pedidos_router, itens_pedidos, vendedores, dimensoes_router
...
app.include_router(dimensoes_router.router, prefix="/dimensoes")
